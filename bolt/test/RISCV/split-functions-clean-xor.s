...
## Use a caller-saved register for C.XOR as well: the dedicated relaxation
## pass deliberately restricts scratch registers to temporaries.
...
# RUN:   -split-strategy=random2 -bolt-seed=1 --pad-funcs-before=xor_func:2097152
...
# RUN:   -split-strategy=random2 -bolt-seed=1 --pad-funcs-before=cxor_func:2097152
